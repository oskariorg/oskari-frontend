...
Oskari.clazz.define('Oskari.mapframework.bundle.infobox.plugin.mapmodule.OpenlayersPopupPlugin',
    ...
    function () {
        ...
        _renderPopup: function (id, contentData, title, lonlat, colourScheme, font, refresh) {
            ...
            // in the search case:
            // contentData contains the name of the selected target from the search
            // Let's dig it out
            var targetTitle = contentData[0].html.substring(4, contentData[0].html.indexOf('</'));

            /* TODO handle refresh, disable for now:
            if (refresh) {
