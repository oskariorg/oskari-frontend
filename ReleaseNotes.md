...
Layers are now required to have "group" registered in the map layer service to be listed in the group. Previously groups were generated by group names without "tangible" groups to link to.
