/**
 * @class Oskari.mapframework.bundle.AkpBundleInstance
 * 
 */
Oskari.clazz.define("Oskari.mapframework.bundle.AkpBundleInstance",
		function() {
			this.map = null;
			this.mapster = null;
			this.ui = null;
			...
			"start" : function() {
				...
				var app = Oskari.clazz
						.create('Oskari.mapframework.akp.Sample');
				this.app = app;
				...
				var layers = Oskari.clazz
						.create(
								'Oskari.mapframework.akp.NlsFiLayerConfig',
								{
