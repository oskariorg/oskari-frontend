...
/**
 * @class Oskari.mapframework.akp.layers.Bundle
 * 
 */
Oskari.clazz
		.define(
				"Oskari.mapframework.akp.layers.Bundle",
				/**
				 * @constructor
				 * 
				 ...
				 */
				{
					...
					"bundle" : {
						"manifest" : {
							...
							"Bundle-Name" : "mapframework.akp.layers.Bundle",
							"Bundle-Author" : [ {
								"Name" : "jjk",
								"Organisation" : "nls.fi",
								"Temporal" : {
 ...
 * 
 */
Oskari.bundle_manager.installBundleClass("layers",
		"Oskari.mapframework.akp.layers.Bundle");
