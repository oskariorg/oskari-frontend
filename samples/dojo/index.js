/**
 * @class Oskari.samples.dojo.Main
 *
 * Launcher Class for a sample featuring dojo.js and 960 layout
 *
 * /samples/dojo/index.html?oskariLoaderMode=yui&style=style1&zoomLevel=8&coord=528574_6759496&mapLayers=base_35+100+!default!,90+100+&showMarker=false&forceCache=true
 *
 */
Oskari.clazz.define('Oskari.samples.dojo.Main', function() {
	...
	start : function() {
		...
		app.startApplication(function(startupInfos) {
			me.instance = startupInfos.bundlesInstanceInfos['dojo'].bundleInstance;
		});
	},
	/**
	 * @static
...
require(["dojo/domReady!"], function() {
	...
	var main = Oskari.clazz.create('Oskari.samples.dojo.Main');
