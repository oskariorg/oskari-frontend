/* This is a unpacked Oskari bundle (bundle script version Thu Feb 23 2012 14:00:50 GMT+0200 (Suomen normaaliaika)) */ 
/**
 * @class Oskari.poc.bundle.DojoUIBundleInstance
 */
Oskari.clazz.define("Oskari.poc.bundle.DojoBundleInstance", function() {
	this.map = null;
	this.core = null;
	this.sandbox = null;
	this.mapmodule = null;
	...
	createModulesAndUi : function(sandbox) {
		 ...
		 * module.setOpts({
		 * 
		 * createMap : true, createMapSketchLayer : false, createMapMarkersLayer :
		 * false, createMapVectorLayer : false, createMapMoveHandlers : true,
		 * addMapControls : true, registerVectorFormats : false, createMapPanel :
		 * true, createTilesGrid : false, 'WfsLayerPlugin' : false,
		 * 'GetInfoPlugin' : true });
		 */
