...
Oskari.clazz
		.define(
				'Oskari.mapframework.ui.manager.transitional.MapFullUiManager',
				function(conf) {
				...
				},
				{
					...
					createModulesAndUi : function(sandbox) {
						...
						var showMapPosition = conf.mapConfigurations.footer;
						if (showMapPosition) {
							var module = Oskari.clazz
...
// lets not add additional panels if we can avoid it
	/*						centerItems.push(Ext.create('Ext.Panel', {
								//region : 'center',
								layout : 'fit',
								items : [ pnl ]
							}));*/
						...
						*/
						...
						this._facade = Oskari.clazz
								.create(
										'Oskari.mapframework.ui.manager.transitional.Facade',
										sandbox,
										this,
										{
											'W' : westPanel,
