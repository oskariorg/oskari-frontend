...
Oskari.clazz
		.define(
				"Oskari.mapframework.transitional.UserInterfaceBundle",
				/**
				 * @constructor
				 * 
				 ...
				 */
				{
					...
					"source" : {
						...
						"scripts" : [{
							...
							"src" : "ui/manager/map-full-ui-manager.js"
						},{
							"type" : "text/javascript",
							"src" : "ui/manager/map-full-ui-facade.js"
						}],
						"resources" : []
					},
					"bundle" : {
						"manifest" : {
							"Bundle-Identifier" : "userinterface",
							"Bundle-Name" : "mapframework.default.UserInterfaceBundle",
							"Bundle-Author" : [ {
								"Name" : "jjk",
								"Organisation" : "nls.fi",
								"Temporal" : {
 ...
 * 
 */
Oskari.bundle_manager.installBundleClass("userinterface",
		"Oskari.mapframework.transitional.UserInterfaceBundle");
