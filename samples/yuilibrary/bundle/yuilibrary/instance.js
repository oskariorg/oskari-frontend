/**
 * @class Oskari.poc.bundle.YuiLibraryUIBundleInstance
 */
Oskari.clazz.define("Oskari.poc.bundle.YuiLibraryUIBundleInstance", function() {
	this.map = null;
	this.core = null;
	this.sandbox = null;
	this.mapmodule = null;
	...
	"start" : function() {
		...
		core.processRequest(core.getRequestBuilder('MapMoveRequest')(449695.09336966, 7097521.8050581, 0, false));
	},
	/**
	 * @method update
	 *
