...
Oskari.clazz.define("Oskari.framework.ext.bundle.StartupBundleInstance",
/**
 * @constructor
 */
function() {
...
Oskari.clazz
		.define(
				"Oskari.framework.ext.bundle.StartupBundle",
				/**
				 * @constructor
				 * 
...

				{
					...
					"create" : function() {
						...
						return Oskari.clazz
								.create("Oskari.framework.ext.bundle.StartupBundleInstance");
					},
				 ...
				 */
				{
					...
					"bundle" : {
						"manifest" : {
							 ...
							 */
							"Bundle-Identifier" : "extstartup",
							"Bundle-Name" : "extstartup",
							"Bundle-Tag" : {
								"mapframework" : true 
							},
 ...
 */
Oskari.bundle_manager.installBundleClass("extstartup",
		"Oskari.framework.ext.bundle.StartupBundle");
