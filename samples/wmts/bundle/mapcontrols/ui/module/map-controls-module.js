...
Oskari.clazz.define('Oskari.mapframework.ui.module.common.MapControlsModule', function() {
    ...
    init : function(sandbox) {
        ...
        this.toolButtonRequestHandler = 
        	Oskari.clazz.create('Oskari.mapframework.mapcontrols.request.ToolButtonRequestHandler', sandbox, me);
    ...
    _createInitialToolbarActions : function(sandbox) {
        ...
        this.actions.map_control_measure_menu = Ext.create('Ext.button.Button', {
            ...
            menu : {
                ...
                plain : true,
                items : [ me.actions.map_control_measure_tool,
                          me.actions.map_control_measure_area_tool ]
            },
            listeners : {
                click : function() {
                    if(this.pressed &&
                       !me.actions.map_control_measure_tool.pressed && 
                       !me.actions.map_control_measure_area_tool.pressed) {
        ...
        // actionFullScreen
/*        this.actions.map_control_full_screen_tool =
        	
            Ext.create('Ext.Button', Ext.create(ga, {
...
*/
    ...
    _getMapToolbarItems : function(sandbox) {
        ...
        var me = this;
        var toolbarItems = [me.actions.map_control_tool_prev,
        					me.actions.map_control_tool_next];
			...
			if(this.extraActions[group]) {
				...
				for(var tool in this.extraActions[group]) {
					if(this.extraActions[group][tool]) {
						var extraToolBtn = Ext.create('Ext.Button', 
				        	Ext.create('Oskari.mapframework.ui.module.common.mapmodule.GeoAction', this.extraActions[group][tool])
				    	);
    ...
    /**
	 * This will return true if browser is Safari and one of selected layers has
	 * opacity < 100. In this case these two browsers fail to print correctly.
	 * 
	 */
