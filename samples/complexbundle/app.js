...
Oskari.clazz
		.define(
				'Oskari.mapframework.complexbundle.Sample',
				...
				},
				{
					 ...
					 * 
					 */
					setBundleConfiguration : function(baseBundleDefinition,
							appBundleDefinition) {
						/**
					...
					createBaseBundles : function(cb) {
						...
						Oskari.bundle_facade.loadBundleDeps(
								baseBundleDefinition['metadata'], cb);
					...
					startApplicationBundles : function(cb) {
						...
						Oskari.bundle_facade
								.playBundle(appBundleDefinition, cb);
