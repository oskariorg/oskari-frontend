...
Oskari.clazz
		.define(
				"Oskari.mapframework.bundle.SampleBundle",
				/**
				 * @constructor
				 * 
...

				{
					...
					"create" : function() {
						...
						return Oskari.clazz
								.create("Oskari.mapframework.bundle.SampleBundleInstance");
					},
 ...
 */
Oskari.bundle_manager.installBundleClass("sample",
		"Oskari.mapframework.bundle.SampleBundle");
