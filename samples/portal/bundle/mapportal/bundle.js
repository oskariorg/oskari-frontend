 ...
 *
 */
Oskari.clazz.define("Oskari.mapframework.mapportal.Bundle",
/**
 * @constructor
 *
 ...
 */
{
	...
	"source" : {
		...
		"scripts" : [{
			...
			"src" : "ui/manager/map-portal-ui-manager.js"
		}, {
			"type" : "text/javascript",
			"src" : "ui/manager/map-portal-ui-facade.js"
		}],
		"resources" : []
	},
	"bundle" : {
		"manifest" : {
			"Bundle-Identifier" : "mapportal",
			"Bundle-Name" : "mapframework.mapportal.Bundle",
			"Bundle-Author" : [{
				"Name" : "jjk",
				"Organisation" : "nls.fi",
				"Temporal" : {
 ...
 *
 */
Oskari.bundle_manager.installBundleClass("mapportal", "Oskari.mapframework.mapportal.Bundle");
