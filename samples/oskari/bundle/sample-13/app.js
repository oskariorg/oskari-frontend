Oskari.clazz
		.define(
				'Oskari.mapframework.sample-13.Sample',
				function() {
					this._core = null;
				...
				},
				{
					...
					createEnhancements : function(conf) {
						...
						// != null);
						  ...
						  var enableMapPublisher = false; var
						  enableNetServiceCenter =
						  (conf.netServiceCenterAvailable == true);
						  
						  enhancements
						  .push(Oskari.clazz.create('Oskari.mapframework.enhancement.mapfull.StartMapWithConfigurationsEnhancement',
								  conf.preSelectedLayers, conf.mapConfigurations)); //
						  
						  
						  enhancements
						  .push(Oskari.clazz.create('Oskari.mapframework.enhancement.mapfull.StartMapWithLinkEnhancement'));
						  /*
					...
					createDefaultExtensionModules : function(conf, uimanager) {
						...
						/* All layers module */
						 ...
						 var allLayersModule =
						  Oskari.clazz.create('Oskari.mapframework.ui.module.layerselector.AllLayersModule'); //
						  uimanager.addExtensionModule(allLayersModule,
						  'allLayersModule', 'NW');
						  
						  
						  var selectedLayersModule =
						  Oskari.clazz.create('Oskari.mapframework.ui.module.layerselector.SelectedLayersModule');
						  uimanager.addExtensionModule(selectedLayersModule,
						  'selectedLayersModule', 'W');
						  
						  var searchModule =
						  Oskari.clazz.create('Oskari.mapframework.ui.module.searchservice.SearchModule');
						  uimanager.addExtensionModule(searchModule,
						  'searchModule', 'E');
						  
						  var metadataModule =
						  Oskari.clazz.create('Oskari.mapframework.ui.module.searchservice.MetadataModule');
						  uimanager.addExtensionModule(metadataModule,
						  'metadataModule', 'E');
						  if(conf.bundles) { for(
								  bundleIndex in conf.bundles ) { var bundle =
									  conf.bundles[bundleIndex];
								  uimanager.addExtensionModule(
										  Oskari.clazz.create(bundle.type, bundle.config),
