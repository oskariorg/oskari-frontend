 ...
 */
Oskari.clazz.define('Oskari.framework.oskari.Sample3', function() {
	...
	start : function() {
		...
		app.startApplication(function(startupInfos) {
			Ext.MessageBox.hide();
			me.instance = startupInfos.bundlesInstanceInfos['sample-3'].bundleInstance;
...
Ext.onReady(function() {
	...
	Oskari.clazz.create('Oskari.framework.oskari.Sample3').start();
});
