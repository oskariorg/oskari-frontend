...
Oskari.clazz
		.define(
				"Oskari.mapframework.adapt.Bundle",
				/**
				 * @constructor
				 * 
...

				{
					...
					"create" : function() {
						...
						return Oskari.clazz.create('Oskari.samples.adapt.BundleInstance');
					},
				 ...
				 */
				{
					...
					"source" : {
						...
						"scripts" : [{
							...
							"type" : "text/javascript",
							"src" : "ui/manager/adapt-ui-manager.js"
						},{
							"type" : "text/javascript",
							"src" : "ui/manager/adapt-ui-facade.js"
						},{
							"type" : "text/javascript",
							"src" : "../../../../bundles/framework/bundle/mapfull/enhancement/start-map-with-configurations-enhancement.js"
						},{
							"type" : "text/javascript",
					...
					"bundle" : {
						"manifest" : {
							"Bundle-Identifier" : "adapt",
							"Bundle-Name" : "mapframework.adapt.Bundle",
							"Bundle-Author" : [ {
								"Name" : "jjk",
								"Organisation" : "nls.fi",
								"Temporal" : {
 ...
 * 
 */
Oskari.bundle_manager.installBundleClass("adapt",
		"Oskari.mapframework.adapt.Bundle");
