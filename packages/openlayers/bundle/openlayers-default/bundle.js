...
(function() {
	...
	Oskari.clazz
			.define(
					"Oskari.mapframework.openlayers.default.Bundle",
					/**
					 * @constructor
					 * 
					 ...
					 */
					{
						...
						"source" : {
							...
							"scripts" : [
									...
									{
										"type" : "text/javascript",
										"src" : "../openlayers-build/full/OpenLayers.js"
									} ],
							"resources" : []
						...
						"bundle" : {
							"manifest" : {
								"Bundle-Identifier" : "openlayers-default",
								"Bundle-Name" : "mapframework.openlayers-default.Bundle",
								"Bundle-Tag" : {
									"mapframework" : true
								},
								"Bundle-Author" : [ {
	 ...
	 * 
	 */
	Oskari.bundle_manager.installBundleClass("openlayers-default",
			"Oskari.mapframework.openlayers.default.Bundle");
