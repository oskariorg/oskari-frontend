(function() {
  ...
  /**
   * @class Oskari.openlayers.bundle.openlayers-published-map.OpenLayersBundle
   *
   */
  Oskari.clazz.define("Oskari.openlayers.bundle.openlayers-published-map.OpenLayersBundle", function() {
