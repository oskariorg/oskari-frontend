...
/**
 * @class Oskari.mapframework.mapster.Bundle
 * 
 */
Oskari.clazz
		.define(
				"Oskari.mapframework.mapster.Bundle",
				/**
				 * @constructor
				 * 
				 ...
				 */
				{
					...
					"source" : {
						...
						"scripts" : [{
							...
							"src" : "../../../../bundles/framework/bundle/mapster/ui/MapPanel.js"
						}],
						"resources" : []
					},
					"bundle" : {
						"manifest" : {
							"Bundle-Identifier" : "mapster",
							"Bundle-Name" : "mapframework.mapster.Bundle",
							"Bundle-Tag" : {
								"mapframework" : true 
							},
							...
							"Bundle-Name-Locale" : {
								"fi" : {
									"Name" : " mapframework.mapster.Bundle",
									"Title" : " mapframework.mapster.Bundle"
								},
								"en" : {}
							},
 ...
 * 
 */
Oskari.bundle_manager.installBundleClass("mapster",
		"Oskari.mapframework.mapster.Bundle");
