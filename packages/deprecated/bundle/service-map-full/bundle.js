/**
 * @class Oskari.mapframework.service.map.full.Bundle
 *
 */
Oskari.clazz.define("Oskari.mapframework.service.map.full.Bundle",
/**
 * @constructor
 *
 ...
 */
{
	...
	"source" : {
		...
		"scripts" : [/*{
			...
			"src" : "../../../../sources/framework/service/ogc-search-service.js"
		}, */{
			"type" : "text/javascript",
			"src" : "../../../../sources/framework/service/net-service-center-service.js"
		}],
		"resources" : []
	},
	"bundle" : {
		"manifest" : {
			"Bundle-Identifier" : "service-map-full",
			"Bundle-Name" : "mapframework.service.map.full.Bundle",
			"Bundle-Tag" : {
				"mapframework" : true
			},
 ...
 *
 */
Oskari.bundle_manager.installBundleClass("service-map-full", "Oskari.mapframework.service.map.full.Bundle");
