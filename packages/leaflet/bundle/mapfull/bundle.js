 ...
 *
 */
Oskari.clazz.define("Oskari.leaflet.bundle.mapfull.MapFullBundle",
/**
 * @constructor
 *
 ...
 */
{
    ...
    "source" : {
        ...
        "scripts" : [{
            ...
            "src" : "../../../../bundles/leaflet/bundle/mapfull/instance.js"
        }, {
            "type" : "text/javascript",
...
Oskari.bundle_manager.installBundleClass("mapfull", "Oskari.leaflet.bundle.mapfull.MapFullBundle");
