...
export const getLayerHelper = () => {
    ...
    const fromOskariMapLayer = (maplayer) => {
        const layer = {
            opacity: maplayer?._opacity || 100,
            groups: maplayer?._groups || [],
            capabilities: maplayer?._capabilities || {},
            options: maplayer?._options || {},
            attributes: maplayer?._attributes || {}
        };
