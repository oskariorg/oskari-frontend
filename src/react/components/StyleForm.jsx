...
const previewPlaceholderIcon = (format, strokeColor, strokeWidth, fillColor) => {
    switch(format) {
        ...
        case 'area':
            return(<svg viewBox="0 0 50 50" width="80" height="80" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="checker" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse"><rect fill="#eee" x="0" width="10" height="10" y="0"><rect fill="#eee" x="10" width="10" height="10" y="10"></rect></rect></pattern></defs><rect x="0" y="0" width="50" height="50" fill="url(#checker)"></rect><path fill="#FAEBD7" stroke="#000000" d="M10,17L40,12L29,40Z" stroke-width="1" stroke-linejoin="miter" stroke-linecap="butt" stroke-dasharray="0"></path></svg>);
        default:
            return;
    }
}
            ...
            <Card>
                ...
                <Row>
                    <Form.Item name='strokeWidthInput' label='Size' initialValue={ 3 } { ...formLayout }>
                        <Input type='number' onChange={ this.styleInputCallback } />
                    </Form.Item>
                </Row>
        ...
        return (
            <Card>
                ...
                <Form.Item name='lineSizeControl' label='Size' initialValue={ 3 } { ...formLayout }>
                    <InputNumber min={ 1 } max={ 5 } formatter={ sizeFormatter } parser={ sizeFormatter } onChange={ (value) => this.setState({ 'strokeWidth': value}) } />
                </Form.Item>
    ...
    _getAreaTab () {
        return (
            <Card>
                ...
                <Row>
                    { this._createPreview(this.state.areaLineColor, this.state.areaFillColor) }
                </Row>
            </Card>
        );
    }
