/**
 * @class Oskari.mapframework.bundle.metadatacatalogue.event.FinishedDrawingEvent
 *
 * Used to notify components that the drawing has been finished.
 */
Oskari.clazz.define('Oskari.mapframework.bundle.metadatacatalogue.event.FinishedDrawingEvent',
/**
...
function(geometry, blnEdit) {
    ...
    __name : "MetaData.FinishedDrawingEvent",
    /**
     * @method getName
     * Returns event name
     * @return {String}
