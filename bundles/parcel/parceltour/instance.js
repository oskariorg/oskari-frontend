 ...
 * Add this to startupsequence to get this bundle started
 ...
 sv : '?',
 en : '?',
 bundlename : 'parceltour',
 bundleinstancename : 'parceltour',
 metadata : {
 "Import-Bundle" : {
 "parceltour" : {
 bundlePath : '/<path to>/packages/parcel/bundle/'
 }
 },
        ...
        _showGuideContentForStep: function (stepIndex, dialog) {
            ...
            if (step.appendTourSeenCheckbox) {
                ...
                var checkboxTemplate =
                    jQuery('<input type="checkbox" ' + 'name="parcel_tour_seen" ' + 'id="parcel_tour_seen" ' + 'value="1">');
                var checkbox = checkboxTemplate.clone();
                var labelTemplate =
                    jQuery('<label for="parcel_tour_seen"></label>');
                ...
                checkbox.bind(
                    ...
                    function () {
                        if (jQuery(this).attr('checked')) {
                            // Set cookie not to show parcel tour again
                            jQuery.cookie(
                                "parcel_tour_seen", "1", {
                                    expires: 365
                                }
                            ...
                            // Revert to show parcel tour on startup
                            jQuery.cookie(
                                "parcel_tour_seen", "0", {
                                    expires: 1
                                }
