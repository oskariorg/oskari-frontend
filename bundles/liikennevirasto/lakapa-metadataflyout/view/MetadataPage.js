        ...
        showMetadataView: function (viewId, target) {
            ...
            for (v in views) {
                if (v !== viewId) {
                    ...
                    titles[v].show();
                    views[v].hide();
                    jQuery(tabs[v]).find('.lakapa-metadata-tab.active').parent().addClass('active');
                    jQuery(tabs[v]).find('.lakapa-metadata-tab.extra-content').parent().addClass('extra_content');
                }
            }
