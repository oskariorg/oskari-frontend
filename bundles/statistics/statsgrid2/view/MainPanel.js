...
Oskari.clazz.define('Oskari.statistics.bundle.statsgrid.view.MainPanel',
    ...
    function (instance) {
		...
		this.grid = Oskari.clazz.create('Oskari.statistics.bundle.statsgrid.controllers.GridController', instance.getLocalization(), instance.getService(), instance.getUserSelections());
    },
    {
    	"__templates" : {
