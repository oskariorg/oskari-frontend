Oskari.clazz.define('Oskari.statistics.statsgrid.SelectedIndicatorsMenu', function(service) {
    ...
    render: function(el) {
        ...
        this._getIndicatorUILabels(function(options) {
            ...
            select.adjustChosen();
            var activeIndicator = !!me.service.getStateService().activeIndicator.hash ? select.setValue( me.service.getStateService().activeIndicator.hash ) : select.selectFirstValue();
            me._select = select;
