...
Oskari.clazz.define("Oskari.analysis.bundle.analyse.view.CategoryForm",
    ...
    function (instance) {
        ...
        this.template = jQuery('<div class="mapanalysiscategoryform">' +
            '<div class="field">' +
        ...
        _populatePointTool: function (table) {
            ...
            for (title in loc) {
                if (loc.hasOwnProperty(title)) {
                    label = this.templateTableCell.clone();
            ...
            pointColorpicker.append(this._createInput('dotColor', this.defaults.dotColor, 'oskaricolor'));
        ...
        _populateLineTool: function (table) {
            ...
            lineColorpicker.append(this._createInput('lineColor', this.defaults.lineColor, 'oskaricolor'));
        ...
        _populateAreaTool: function (table) {
            ...
            areaColorpicker.append(this._createInput('areaFillColor', this.defaults.areaFillColor, 'oskaricolor'));
            toolRow.append(areaColorpicker);

            var lineColorpicker = this.templateTableCell.clone();
            lineColorpicker.append(this._createInput('areaLineColor', this.defaults.areaLineColor, 'oskaricolor'));
            toolRow.append(lineColorpicker);
        ...
        _getOnScreenForm: function () {
            return jQuery('div.mapanalysiscategoryform');
        },
        /**
         * @method destroy
         */
