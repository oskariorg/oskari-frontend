...
Oskari.clazz.define('Oskari.harava.bundle.mapmodule.plugin.HaravaDrawSearchGeometryPlugin',
    ...
    function (locale) {
        ...
        init: function (sandbox) {
            ...
            this.searchControls.regularPolygon.handler.setOptions({
                irregular: true
            });
            ...
            jQuery('.searchbygeom-tool').live('click', function () {
                ...
                case 'searchbygeom-mapextent':
                    mapExtent = me._map.getExtent();
                    mapExtentPolygon = 'POLYGON((' + mapExtent.left + ' ' + mapExtent.top + ',' + mapExtent.right + ' ' + mapExtent.top + ',' + mapExtent.right + ' ' + mapExtent.bottom + ',' + mapExtent.left + ' ' + mapExtent.bottom + ',' + mapExtent.left + ' ' + mapExtent.top + '))';
