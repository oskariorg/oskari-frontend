...
Oskari.clazz.define('Oskari.harava.bundle.mapmodule.plugin.HaravaDrawPlugin',
    ...
    function (locale, conf) {
        ...
        toggleVisibility: function (visible, removeAllFeatures) {
            ...
            if (removeAllFeatures !== null && removeAllFeatures !== undefined && removeAllFeatures) {
        ...
        init: function (sandbox) {
            ...
            me._drawLayer = new OpenLayers.Layer.Vector("Harava geometry layer", {
                eventListeners: {
                    ...
                    'featureunselected': function (evt) {
                        ...
                        if (me._conf.popupHtml !== null && me._conf.popupHtml !== undefined && jQuery('#kana').is(':visible')) {
            ...
            if (me._conf && me._conf.visibility !== null && me._conf.visibility !== undefined) {
        ...
        getAllFeatures: function () {
            ...
            jQuery.each(me._drawLayer.features, function (k, feature) {
                ...
                if (geom !== null && geom !== undefined && typeof geom.toString === 'function') {
        ...
        deleteSelectedFeature: function (oldMode) {
            ...
            if (me._lastfeature !== null && me._lastfeature !== undefined) {
        ...
        showPopup: function (lonlat, feature) {
            ...
            if (me._conf.popupHtml !== null && me._conf.popupHtml !== undefined) {
                ...
                if (feature.popupHtml === null || feature.popupHtml === undefined) {
                ...
                if (feature.attributes.value !== null && feature.attributes.value !== undefined) {
                    jQuery('#harava-draw-popup-value').val(feature.attributes.value);
                }
                if (feature.attributes.date !== null && feature.attributes.date !== undefined) {
                    jQuery('#harava-draw-popup-date').val(feature.attributes.date);
                }
                if (feature.attributes.additionalData) {
