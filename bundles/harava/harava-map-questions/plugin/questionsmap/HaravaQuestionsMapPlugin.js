...
Oskari.clazz.define('Oskari.harava.bundle.mapquestions.plugin.HaravaQuestionsMapPlugin',
    ...
    function (config) {
        ...
        "onPopupClose": function (evt, me) {
            ...
            jQuery.each(me.modules, function (k, module) {
                if (module.layer && module.layer.features !== null && module.layer.features !== undefined) {
        ...
        startPlugin: function (sandbox) {
            ...
            if (conf && conf.modules !== null && conf.modules !== undefined) {
                ...
                jQuery.each(me.modules, function (k, module) {
                    ...
                    if (obj && obj.namedLayers) {
                        for (var p in obj.namedLayers) {
                            ...
                            for (k = 0; k < style.rules.length; k++) {
                    ...
                    var key;
                    for (key in module.drawControls) {
                        me._map.addControl(module.drawControls[key]);
                    }
                    for (key in module.modifyControls) {
        ...
        setExternalGraphicStyles: function (style, module) {
            jQuery.each(module.questions, function (q, question) {
                if (question.type === 'point' && question.imageUrl) {
                    jQuery.each(style.rules, function (r, rule) {
                        if (rule.filter.value == module.questionId + question.id) {
                            var graphicXOffset = -16;
                            if (question.imageXOffset !== null && question.imageXOffset !== undefined) {
                                graphicXOffset = question.imageXOffset;
                            }
                            var graphicYOffset = -16;
                            if (question.imageYOffset !== null && question.imageYOffset !== undefined) {
                                graphicYOffset = question.imageYOffset;
                            }
                            var opacity = 1;
                            if (question.opacity !== null && question.opacity !== undefined) {
            ...
            jQuery.each(module.questions, function (q, question) {
                ...
                if (question.type === 'point') {
                    ...
                    if (question.imageUrl) {
                        var imgSize = '32';
                        if (question.imageSize !== null && question.imageSize !== undefined) {
                    ...
                    /* Else if not defined imageUrl*/
                        ...
                        var strokeOpacity = 1;
                        if (question.strokeOpacity !== null && question.strokeOpacity !== undefined) {
                ...
                /* If line type */
                    ...
                    var strokeWidth = 2;
                    if (question.strokeWidth !== null && question.strokeWidth !== undefined) {
