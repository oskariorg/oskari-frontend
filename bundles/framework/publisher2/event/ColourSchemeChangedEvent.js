/**
 * @class Oskari.mapframework.bundle.publisher2.event.ColourSchemeChangedEvent
 *
 * Used to notify getinfo plugin that the colour scheme has changed.
 */
Oskari.clazz.define('Oskari.mapframework.bundle.publisher2.event.ColourSchemeChangedEvent',
    ...
    function (colourScheme) {
        ...
        __name: 'Publisher2.ColourSchemeChangedEvent',
        /**
         * @method getName
         * Returns event name
         * @return {String}
