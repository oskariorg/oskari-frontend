...
Oskari.clazz.define('Oskari.framework.bundle.admin-announcements.AdminAnnouncementsBundleInstance',
    ...
    function () {
         ...
         * Oskari.framework.bundle.admin-announcements.Flyout
         * Oskari.framework.bundle.admin-announcements.Tile
         */
        startExtension: function () {
            this.plugins['Oskari.userinterface.Flyout'] = Oskari.clazz.create(
                'Oskari.framework.bundle.admin-announcements.Flyout', this);
            this.plugins['Oskari.userinterface.Tile'] = Oskari.clazz.create(
                'Oskari.framework.bundle.admin-announcements.Tile', this, this.getLocalization());
        },
        /**
        ...
        /**
         * @method createUi
         * (re)creates the UI for admin-announcements functionality
         */
        createUi: function () {
            this.plugins['Oskari.userinterface.Tile'].refresh();
        }
