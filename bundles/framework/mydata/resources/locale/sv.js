Oskari.registerLocalization(
{
    ...
    "value": {
        ...
        "desc": "Mina uppgifter",
        "notLoggedIn": "Mina uppgifter innehåller din användarprofil och alla dina sparade funktioner, kartvyer, publicerade kartor, indikatorer och datamängder.",
        ...
        "guidedTour": {
            "title": "Min data",
            "message": "\"Min data\"-menyn innehåller alla dina sparade platser, kartvyer, publicerade kartor, indikatorer och datamängder. Där kan du också kontrollera din kontoinformation. Mina data visas endast för inloggade användare.",
