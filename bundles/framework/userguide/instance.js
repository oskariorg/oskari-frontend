        ...
        __guidedTourDelegateTemplate: {
            ...
            getLinks: function () {
                ...
                return [
                    {
                        title: loc.openLink,
                        onClick: () => me.sandbox.postRequestByName('userinterface.UpdateExtensionRequest', [null, 'attach', 'userinterface.UserGuide']),
                        visible: false
                    },
                    {
                        title: loc.closeLink,
                        onClick: () => me.sandbox.postRequestByName('userinterface.UpdateExtensionRequest', [null, 'close', 'userinterface.UserGuide']),
                        visible: true
                    }
                ];
            }
