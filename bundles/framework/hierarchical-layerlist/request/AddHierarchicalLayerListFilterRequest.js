/**
 * @class Oskari.framework.bundle.hierarchical-layerlist.request.AddHierarchicalLayerListFilterRequest
 ...
 */
Oskari.clazz
    .define('Oskari.framework.bundle.hierarchical-layerlist.request.AddHierarchicalLayerListFilterRequest',
    /**
     ...
     * @param {String} filterName filter name, used on {Oskari.framework.bundle.hierarchical-layerlist.request.ShowFilteredLayerListRequest} if wanted acivate selected filter
     */
        ...
        __name : "AddHierarchicalLayerListFilterRequest",
        /**
         * @method getName
