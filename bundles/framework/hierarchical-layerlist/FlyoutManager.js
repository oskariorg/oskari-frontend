Oskari.clazz.define('Oskari.framework.bundle.hierarchical-layerlist.FlyoutManager', function (instance) {
    ...
    init: function () {
        ...
        this.flyoutInfo.forEach(function(info) {
            ...
            flyout.makeDraggable({
                handle : '.oskari-flyouttoolbar, .hierarchical-layerlist-data-container > .header',
                scroll : false
            });
