/**
 * @class Oskari.framework.bundle.hierarchical-layerlist.view.PublishedLayersTab
 *
 */
Oskari.clazz.define("Oskari.framework.bundle.hierarchical-layerlist.view.PublishedLayersTab",
        ...
        _populateLayerGroups: function (jsonResponse) {
            ...
            for (n = 0; n < jsonResponse.length; n += 1) {
                ...
                if (!group || group.getTitle() !== groupJSON.name) {
                    group = Oskari.clazz.create("Oskari.framework.bundle.hierarchical-layerlist.model.LayerGroup", groupJSON.name);
        ...
        showLayerGroups: function (groups) {
            ...
            for (i = 0; i < groups.length; i += 1) {
                ...
                for (n = 0; n < layers.length; n += 1) {
                    layer = layers[n];
                    layerWrapper =
                        Oskari.clazz.create('Oskari.framework.bundle.hierarchical-layerlist.view.Layer',
