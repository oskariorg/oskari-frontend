/**
 * @class Oskari.framework.bundle.hierarchical-layerlist.view.Layer
 *
 *
 */
Oskari.clazz.define("Oskari.framework.bundle.hierarchical-layerlist.view.Layer",
    ...
    function (layer, sandbox, localization) {
        ...
        _createLayerContainer: function (layer) {
            ...
            layerDiv.find('input').attr('id', 'oskari_hierarchical-layerlist_layerlist_checkbox_layerid_' + layer.getId());
