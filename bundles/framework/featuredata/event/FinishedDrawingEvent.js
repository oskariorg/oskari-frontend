/**
 * @class Oskari.mapframework.bundle.featuredata.event.FinishedDrawingEvent
 * 
 * Used to notify components that the drawing has been finished. 
 */
Oskari.clazz.define('Oskari.mapframework.bundle.featuredata.event.FinishedDrawingEvent', 
/**
