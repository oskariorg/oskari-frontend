Oskari.registerLocalization(
{
    ...
    "value": {
        ...
        "flyout": {
            ...
            "description": "Lataa aineisto tietokoneeltasi yhdeksi zip-tiedostoksi pakattuna, joka sisältää tarvittavat tiedostot jostain seuraavasta tiedostomuodosta:<ul><li>Shapefile (.shp, .shx, .dbf ja .prj sekä mahdollinen .cpg)</li><li>GPX-siirtotiedosto (.gpx)</li><li>GeoPackage-tiedosto (.gpkg)</li><li>GeoJSON-tiedosto (.json tai .geojson)</li><li>MapInfo (.mif ja .mid)</li><li>Google Maps (.kml)</li></ul>Zip-tiedosto saa sisältää vain yhden karttatason ja sen maksimikoko on {maxSize, number} Mt. Purettuna tiedoston koko saa olla korkeintaan {unzippedMaxSize, number} Mt.",
