 ...
 */
Oskari.clazz.define(
    'Oskari.mapframework.bundle.admin-users.AdminRoles',
    function (localization, parent) {
        ...
        addRoleToList: function (role) {
            var me = this;
            jQuery(me.container).find('.admin-role-list ul').append(
                this._populateItem(role)
            );
        },
        ...
        createUi: function () {
            ...
            me.renderRoles();
            button = Oskari.clazz.create('Oskari.userinterface.component.buttons.AddButton');
        ...
        createLayerRightGrid: function (columnHeaders, layerRightsJSON) {
            ...
            table += '    </tr>';
            table += '</thead>';
            service = this.instance.getSandbox().getService(
