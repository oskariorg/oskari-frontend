/**
 * @class Oskari.mapframework.bundle.selected-featuredata.event.TabChangedEvent
 *
 * Used to notify metadatacatalogue that the tab has changed
 */
Oskari.clazz.define('Oskari.mapframework.bundle.selected-featuredata.event.TabChangedEvent',
/**
...
function(previousTabId, newTabId) {
    ...
    __name : "SelectedFeatureData.TabChangedEvent",
    /**
     * @method getName
     * Returns event name
     * @return {String}
