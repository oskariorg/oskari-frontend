Oskari.registerLocalization(
    {
        ...
        'value': {
            ...
            'tabs': {
                'layerList': 'Rechercher parmi les couches cartographiques',
                'selectedLayers': 'Couches sélectionnées'
            },
            'filter': {
                'title': 'Afficher',
                'all': {
            ...
            'layer': {
                'tooltip': {
                    'timeseries': 'Couche chronologique'
                },
                'styles': {
                    'title': 'Style'
                },
                'moveToScale': "Veuillez choisir un niveau d'échelle adapté",
                'moveToContentArea': 'Veuillez vous déplacer sur un emplacement adapté',
                'publishable': 'Publiable',
                'hidden': 'La couche cartographique est temporairement masquée'
            },
            'backendStatus': {
                'OK': 'La couche cartographique est actuellement disponible.',
