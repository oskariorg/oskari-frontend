define(["oskari","jquery","./domain/WfsLayer","./domain/WfsLayerModelBuilder","./domain/QueuedTile","./domain/TileQueue","./domain/WfsTileRequest","./event/WFSFeaturesSelectedEvent","./service/WfsTileService","./plugin/wfslayer/QueuedTilesGrid","./plugin/wfslayer/QueuedTilesStrategy","./plugin/wfslayer/WfsLayerPlugin","./instance","./locale/fi","./locale/sv","./locale/en"], function(Oskari,jQuery) {
