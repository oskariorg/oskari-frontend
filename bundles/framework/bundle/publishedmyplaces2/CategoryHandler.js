...
function(instance) {
    ...
    editCategory : function(category) {
        ...
        var form = Oskari.clazz.create('Oskari.mapframework.bundle.publishedmyplaces.view.CategoryForm', me.instance);
        var values = {
    ...
    getCategoryFromFormValues : function(values) {
        var category = Oskari.clazz.create('Oskari.mapframework.bundle.publishedmyplaces.model.MyPlacesCategory');
