...
function() {
    ...
    start : function() {
        ...
        var $el = $(el), data = $el.data(), Spinner = this._Spinner, opts = this.opts;
        ;
    ...
    _Spinner : (function(window, document, undefined) {
        ...
        merge(Spinner.prototype, {
            spin : function(target) {
                ...
                if(!useCssAnimations) {
                    ...
                    var i = 0, fps = o.fps, f = fps / o.speed, ostep = (1 - o.opacity) / (f * o.trail / 100), astep = f / o.lines; (function anim() {
                        i++;
