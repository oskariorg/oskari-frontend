...
Oskari.clazz.define('Oskari.userinterface.component.VisualizationForm',
    ...
    getForm: function() {
        var me = this,
            ...
            btnContainer, formName, formClazz;
    ...
    _getFormClazz: function(formName) {
        if (formName != null) {
            return this._formClazzes[formName];
        } else {
            return this._formClazzes;
        }
    },
    ...
    _getLocalization: function(locKey) {
        ...
        if (locale) {
            return locale[this._defaultLocKey];
        } else {
            return null;
        }
    },
    ...
    _createFormClazzes: function(formNames, formValues) {
        var i = 0, fLen = (formNames ? formNames.length : 0), fClazzes = {},
            fName, fValues, fClazz;
