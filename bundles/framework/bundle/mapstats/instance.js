/**
 * @class Oskari.mapframework.bundle.mapstats.MapStatsBundleInstance
 */
Oskari.clazz.define("Oskari.mapframework.bundle.mapstats.MapStatsBundleInstance", function(b) {
	this.name = 'MapStats';
	this.mediator = null;
	this.sandbox = null;
