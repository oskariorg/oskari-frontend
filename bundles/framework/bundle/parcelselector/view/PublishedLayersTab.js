/**
 * @class Oskari.mapframework.bundle.parcelselector.view.PublishedLayersTab
 * 
 */
Oskari.clazz.define("Oskari.mapframework.bundle.parcelselector.view.PublishedLayersTab",
    ...
    _populateLayerGroups : function(jsonResponse) {
        ...
        for (var n = 0; n < jsonResponse.length; ++n) {
            ...
            if (!group || group.getTitle() != groupJSON.name) {
                group = Oskari.clazz.create("Oskari.mapframework.bundle.parcelselector.model.LayerGroup", groupJSON.name);
    ...
    showLayerGroups : function(groups) {
        ...
        for(var i = 0; i < groups.length; ++i) {
            ...
            for(var n = 0; n < layers.length; ++n) {
                var layer = layers[n];
                var layerWrapper = 
                    Oskari.clazz.create('Oskari.mapframework.bundle.parcelselector.view.Layer',
