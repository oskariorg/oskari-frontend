    ...
    function () {
        ...
        purgeOffset: function (offset) {
            var ref = new Date().getTime() - offset,
                ...
                style,
                bbox;
            for (layerId in this.data) {
                if (this.data.hasOwnProperty(layerId)) {
                    for (style in this.data[layerId]) {
                        if (this.data[layerId].hasOwnProperty(style)) {
                            for (bbox in this.data[layerId][style]) {
                                if (this.data[layerId][style].hasOwnProperty(bbox)) {
