Oskari.registerLocalization({
    ...
    "value": {
        ...
        "edit": {
            "popup": {
                "title": "Edytowanie wbudowanej mapy",
                "msg": "Dane mapy wcześniej wbudowanej zostały zaktualizowane"
            }
        },
        "BasicView": {
            "title": "Wbudowana mapa",
            "titleEdit": "Edytuj wbudowaną mapę",
            "domain": {
                "title": "Strona gdzie mapa będzie wbudowana",
                "label": "Witryna gdzie mapa będzie wbudowana",
                "placeholder": "bez prefiksów http lub www",
                "tooltip": "Napisz nazwę strony internetowej, np. jej domeny bez prefiksów http lub www lub adres podstrony. Przykład: myhomepage.com"
            },
            "name": {
                "label": "Nazwa mapy",
            ...
            "tools": {
                ...
                "IndexMapPlugin": "Indeks mapy",
                "PanButtons": "Narzędzie przesuń (\"pan\")",
                "Portti2Zoombar": "Pasek przewijania skali",
            ...
            "confirm": {
                "replace": {
                    "title": "Czy chcesz zastąpić(zamienić) wbudowaną mapę?",
                    "msg": "Zastosuj zamień aby pokazać zmiany wbudowanej mapy bez opóźnień."
                }
            },
            "layerselection": {
            ...
            "error": {
                "title": "Błąd!",
                "size": "Błąd w definicjach rozmiaru",
                "domain": "Strona wymaga informacji",
                "domainStart": "W nazwie strony pomiń prefiksy http lub www ",
        ...
        "StartView": {
            ...
            "touLink": "Pokaż regulamin dla Wbudowanych map",
            "layerlist_title": "Wbudowane warstwy mapy",
            ...
            "tou": {
                "notfound": "Nie można znaleźć regulaminu",
                "reject": "Odrzuć",
                "accept": "Akceptuj"
            }
        },
