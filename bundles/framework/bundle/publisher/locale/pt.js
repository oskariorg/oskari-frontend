Oskari.registerLocalization(
{
    ...
    "value": {
        ...
        "edit": {
            "popup": {
                "title": "Editar carta embutida",
                "msg": "Os dados de uma carta embutida anteriormente estão em atualização"
            }
        },
        "BasicView": {
            "title": "Embutir carta",
            "titleEdit": "Editar carta embutida",
            "domain": {
                "title": "Página web onde vai embutir a carta",
                "label": "Sítio web onde vai embutir a carta",
                "placeholder": "sem os prefixos http ou www",
                "tooltip": "Escreva o nome da página índice do seu sítio web, e.g. o domínio sem os prefixos http ou www, ou o endereço de uma subpágina. Exemplo: myhomepage.com"
            },
            "name": {
                "label": "Nome da carta",
            ...
            "tools": {
                ...
                "IndexMapPlugin": "Esquema de enquadramento",
                "PanButtons": "Ferramenta panorâmica",
                "Portti2Zoombar": "Barra de variação de escala",
            ...
            "confirm": {
                "replace": {
                    "title": "Deseja substituir a carta embutida?",
                    "msg": "Use substituir para apresentar alterações à carta embutida de imediato. Não é necessário adicionar novamente o código html à sua página web"
                }
            },
            "layerselection": {
            ...
            "error": {
                "title": "Erro!",
                "size": "Erro na definição da dimensão",
                "domain": "O sítio web é informação obrigatória",
                "domainStart": "Omitir prefixos http ou www no nome do sítio web",
        ...
        "StartView": {
            ...
            "touLink": "Apresentar os termos de utilização de  cartas embutidas",
            "layerlist_title": "Camadas que se podem embutir",
            ...
            "tou": {
                "notfound": "Termos de utilização não encontrados",
                "reject": "Rejeitar",
                "accept": "Aceitar"
            }
        },
