Oskari.registerLocalization(
{
    ...
    "value": {
        ...
        "edit": {
            "popup": {
                "title": "Ndryshimi i hartës së futur",
                "msg": "Të dhënat e hartës së futur më herët janë duke u azhurnuar"
            }
        },
        "BasicView": {
            "title": "Harta e futur",
            "titleEdit": "Ndrysho hartën e futur",
            "domain": {
                "title": "Ueb faqja (Webpage) ku harta do të futet",
                "label": "Ueb faqja (Website) ku harta do të futet",
                "placeholder": "Pa parashtesat http apo www",
                "tooltip": "Shkruani indeksin e ueb faqes tuaj p.sh. Emrin e domenit pa parashtresat http apo www, apo pa adresën e nënfaqes. Për shembull: myhomepage.com"
            },
            "name": {
                "label": "Emri i hartës",
            ...
            "tools": {
                ...
                "IndexMapPlugin": "Harta indeks",
                "PanButtons": "Vegla lëvizëse",
                "Portti2Zoombar": "Shiriti lëvizës i shkallës",
            ...
            "confirm": {
                "replace": {
                    "title": "A dëshironi që ta rivendosni hartën e futur?",
                    "msg": "Përdor menyn rivendos për të treguar ndryshimet e bëra në hartën e futur pa vonesë. Nuk është e nevojshme që të shtoni kodin-html në ueb faqen tuaj prap"
                }
            },
            "layerselection": {
            ...
            "error": {
                "title": "Gabim!",
                "size": "Gabim në definicionet e madhësisë",
                "domain": "Ueb faqja është informatë e kërkuar",
                "domainStart": "Hiq parashtresat http apo www nga emri i ueb faqes",
        ...
        "StartView": {
            ...
            "touLink": "Paraqit Kushtet e përdorimit për hartat e futura",
            "layerlist_title": "Shtresat e hartës që mund të futen (embeddable)",
            ...
            "tou": {
                "notfound": "Nuk mund të gjinden Kushtet e përdorimit",
                "reject": "Refuzo",
                "accept": "Prano"
            }
        },
