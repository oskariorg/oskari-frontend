    ...
    this.template = jQuery('<div class="basic_publisher">' + 
    	'<div class="form">' + 
    		'<div class="field">' + 
    			...
    			'title="' + localization.domain.tooltip + '"></div>' + 
    		...
    		'</div>' +
    	    '<div class="field">' + 
    	    	'<div class="help icon-info" title="' + localization.name.tooltip + '"></div>' +
    	    	'<label for="name">' + localization.name.label + '</label><br clear="all" />' +
    	    	'<input name="name" placeholder="' + localization.name.placeholder + '"/>' +
    	    '</div>' + 
    	    '<div class="field">' + 
    	    	'<div class="help icon-info" title="' + localization.language.tooltip + '"></div>' + 
    	    	'<label for="language">' + localization.language.label + '</label><br clear="all" />' +
    	    	'<select name="language"></select>' + '</div>' +
    	    	
    	    	'<div class="buttons">' + '</div>' +
    	    '</div>' +
    	    '<div class="map">' + localization.preview +
    	    	// '<div class="preview">' + '</div>' + 
    	    	'<div class="maplocation">' + localization.location + '<div class="locationdata"></div>' + '</div>' +
