...
Oskari.clazz.define(
    ...
    function(instance, localization) {
        ...
        this.template = jQuery("<div class='startview'>"
                               + "<div class='content'></div>"
                               + "<div class='buttons'></div>"
                               + "</div>");
        this.templateLayerList = jQuery("<div class='layerlist'>"
                                        + "<h4></h4>"
                                        + "<ul></ul>"
                                        + "</div>");
        ...
        _renderLayerLists : function() {
            ...
            if (layers.length > 0) {
                ...
                if (deniedLayers.length > 0) {
                    var deniedLayersList = 
                        this._getRenderedLayerList(deniedLayers);
        ...
        _hasPublishRight : function(layer) {
            ...
            // or nothing at all
            return (layer.getPermission('publish') == 
                    'publication_permission_ok');
        },
        /**
