define(["oskari","jquery","./instance","./Flyout","./Tile","./event/MapPublishedEvent","./view/NotLoggedIn","./view/StartView","./view/BasicPublisher","./view/PublisherLocationForm","./view/PublisherLayerForm","css!_resources_/framework/bundle/publisher/css/style.css","./request/PublishMapEditorRequest","./request/PublishMapEditorRequestHandler","./locale/fi","./locale/sv","./locale/en"], function(Oskari,jQuery) {
