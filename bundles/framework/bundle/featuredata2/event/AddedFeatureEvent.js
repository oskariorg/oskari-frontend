/**
 * @class Oskari.mapframework.bundle.featuredata2.event.AddedFeatureEvent
 *
 * Used to notify components that the feature has been added.
 */
Oskari.clazz.define('Oskari.mapframework.bundle.featuredata2.event.AddedFeatureEvent',
/**
