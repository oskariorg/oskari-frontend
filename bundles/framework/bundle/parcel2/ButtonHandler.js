/**
 * @class Oskari.mapframework.bundle.parcel2.ButtonHandler
 * 
 * Handles the buttons for parcel functionality
 */
Oskari.clazz.define("Oskari.mapframework.bundle.parcel2.ButtonHandler",
...
function(instance) {
    ...
    stop : function() {
        ...
        jQuery('div.parcel2 div.button').die();
    },
    /**
     * @method onEvent
    ...
    eventHandlers : {
         ...
         * Place was selected
         * @param {Oskari.mapframework.bundle.parcel2.event.ParcelSelectedEvent} event
         */
