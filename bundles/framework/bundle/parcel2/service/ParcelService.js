/**
 * @class Oskari.mapframework.bundle.parcel2.service.ParcelService
 * 
 */
Oskari.clazz.define('Oskari.mapframework.bundle.parcel2.service.ParcelService', 
...
function(url, uuid, sandbox, defaultName) {
    ...
    this.wfstStore = Oskari.clazz.create('Oskari.mapframework.bundle.parcel2.service.ParcelWFSTStore', url, uuid);
    this._sandbox = sandbox;
    this.defaultCategory = null;
    this.defaultCategoryName = defaultName;
}, {
    __qname : "Oskari.mapframework.bundle.parcel2.service.ParcelService",
    getQName : function() {
        return this.__qname;
    },
    ...
    _createDefaultCategory : function() {
    	var me = this;
        var defaultCategory = Oskari.clazz.create('Oskari.mapframework.bundle.parcel2.model.ParcelCategory');
     ...
     * @param {Number} id
     * @return {Oskari.mapframework.bundle.parcel2.model.Parcel}
     */
     ...
     * @param {Number} id
     * @return {Oskari.mapframework.bundle.parcel2.model.ParcelCategory}
     */
