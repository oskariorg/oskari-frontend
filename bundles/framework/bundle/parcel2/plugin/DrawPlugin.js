/**
 * @class Oskari.mapframework.bundle.parcel2.plugin.DrawPlugin
 */
Oskari.clazz.define('Oskari.mapframework.bundle.parcel2.plugin.DrawPlugin', function() {
    this.mapModule = null;
    ...
    init : function(sandbox) {
        ...
        this.requestHandlers = {
            startDrawingHandler : Oskari.clazz.create('Oskari.mapframework.bundle.parcel2.request.StartDrawingRequestPluginHandler', sandbox, me),
            stopDrawingHandler : Oskari.clazz.create('Oskari.mapframework.bundle.parcel2.request.StopDrawingRequestPluginHandler', sandbox, me),
            getGeometryHandler : Oskari.clazz.create('Oskari.mapframework.bundle.parcel2.request.GetGeometryRequestPluginHandler', sandbox, me)
        };
    ...
    startPlugin : function(sandbox) {
        ...
        sandbox.addRequestHandler('Parcel.GetGeometryRequest', this.requestHandlers.getGeometryHandler);
    ...
    stopPlugin : function(sandbox) {
        ...
        sandbox.removeRequestHandler('Parcel.GetGeometryRequest', this.requestHandlers.getGeometryHandler);
