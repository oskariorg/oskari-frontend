/**
 * @class Oskari.mapframework.bundle.parcel2.view.PlaceForm
 * 
 * Shows a form for my place
 */
Oskari.clazz.define("Oskari.mapframework.bundle.parcel2.view.PlaceForm",
...
function(instance) {
    ...
    /**
     * @method getForm
     * @param {Oskari.mapframework.bundle.parcel2.model.ParcelCategory[]} categories array containing available categories
    ...
    _bindCategoryChange : function() {
        ...
        onScreenForm.find('select[name=category]').live('change', function() {
            ...
            if(value == me.newCategoryId) {
                me.categoryForm = Oskari.clazz.create('Oskari.mapframework.bundle.parcel2.view.CategoryForm', me.instance);
