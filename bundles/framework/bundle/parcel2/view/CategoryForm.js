/**
 * @class Oskari.mapframework.bundle.parcel2.view.CategoryForm
 * 
 * Shows a form for a parcel category
 */
Oskari.clazz.define("Oskari.mapframework.bundle.parcel2.view.CategoryForm",
...
function(instance) {
    ...
    this.template = jQuery('<div class="parcelcategoryform">' +
            '<div class="field">' +   
    ...
    _getOnScreenForm : function() {
        return jQuery('div.parcelcategoryform');
    },
    /**
     * @method destroy
     */
    destroy : function() {
        ...
        //jQuery('div.parcelcategoryform input.oskaricolor').off();
        var onScreenForm = this._getOnScreenForm();
        onScreenForm.remove();
    }
});
