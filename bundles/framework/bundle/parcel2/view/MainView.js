 ...
 * Oskari.mapframework.bundle.parcel2.plugin.CoordinatesPlugin plugin for main map.
 */
Oskari.clazz.define("Oskari.mapframework.bundle.parcel2.view.MainView",
...
function(instance) {
    ...
    start : function() {
        ...
        var drawPlugin = Oskari.clazz.create('Oskari.mapframework.bundle.parcel2.plugin.DrawPlugin');
        ...
        /*var hoverPlugin = Oskari.clazz.create('Oskari.mapframework.bundle.parcel2.plugin.HoverPlugin');
    ...
    eventHandlers : {
         ...
         * @param {Oskari.mapframework.bundle.parcel2.event.FinishedDrawingEvent} event
         */
     ...
     * @param {Oskari.mapframework.bundle.parcel2.model.Parcel} place prepoluate form with place data (optional)
     */
    showPlaceForm : function(location, place) {
        ...
        this.form = Oskari.clazz.create('Oskari.mapframework.bundle.parcel2.view.PlaceForm', this.instance);
     ...
     * @private
     * @param {Object} values form values as returned by Oskari.mapframework.bundle.parcel2.view.PlaceForm.getValues()
     * @return {Object[]} 
     */
    ...
    __savePlace : function(values) {
        ...
        var place = Oskari.clazz.create('Oskari.mapframework.bundle.parcel2.model.Parcel');
        var oldCategory = -1;
        if(values.id) {
