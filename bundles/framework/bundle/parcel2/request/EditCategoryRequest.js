/**
 * @class Oskari.mapframework.bundle.parcel2.request.EditCategoryRequest
 * Requests a "my place" maplayer/category to be opened for editing
 * 
 * Requests are build and sent through Oskari.mapframework.sandbox.Sandbox.
 * Oskari.mapframework.request.Request superclass documents how to send one.
 */
Oskari.clazz.define('Oskari.mapframework.bundle.parcel2.request.EditCategoryRequest', 
