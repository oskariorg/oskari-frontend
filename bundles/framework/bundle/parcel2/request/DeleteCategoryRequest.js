/**
 * @class Oskari.mapframework.bundle.parcel2.request.DeleteCategoryRequest
 * Requests a "my place" maplayer/category to be deleted
 * 
 * Requests are build and sent through Oskari.mapframework.sandbox.Sandbox.
 * Oskari.mapframework.request.Request superclass documents how to send one.
 */
Oskari.clazz.define('Oskari.mapframework.bundle.parcel2.request.DeleteCategoryRequest', 
