Oskari.clazz.define(
        'Oskari.mapframework.bundle.parcel2.request.StopDrawingRequestPluginHandler',
        ...
        },
        {
            handleRequest: function(core,request) {
                this.sandbox.printDebug("[Oskari.mapframework.bundle.parcel2.request.StopDrawingRequestPluginHandler] Stop drawing");
                if(request.isCancel()) {
