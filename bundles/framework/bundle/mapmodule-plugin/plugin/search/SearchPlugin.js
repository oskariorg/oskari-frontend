...
function(config) {
    ...
    init : function(sandbox) {
        ...
        this.template = jQuery('<div class="search-div">' +
            ...
            '</div>' + 
            '<div class="results">' + 
            '<div class="header"><div class="close icon-close" title="' + this.loc['close']  + '"></div></div>' +
            '<div class="content">&nbsp;</div>' +
            '</div>' +
            '</div>');
        
        this.templateResultsTable = jQuery("<table><thead><tr>" +
            "<th>" + this.loc['column_name'] + "</th>" +
            "<th>" + this.loc['column_village'] + "</th>" +
            "<th>" + this.loc['column_type'] + "</th>" +
