...
Oskari.$("SnappyGrid", OpenLayers.Class(OpenLayers.Layer.HTTPRequest, {
    ...
    initGriddedTiles: function (bounds) {
        ...
        // FIXME colidx is used out of scope
    ...
    spiralTileLoad: function () {
        var tileQueue = [],
            ...
            iRow = 0,
            iCell = -1,
            direction = OpenLayers.Util.indexOf(directions, "right"),
            directionsTried = 0,
            testRow,
            testCell,
            tile;
        ...
        while (directionsTried < directions.length) {
            ...
            if ((tile !== null && tile !== undefined) && (!tile.queued)) {
...
Oskari.$("SnappyWMSLayer", OpenLayers.Class(OpenLayers.Layer.Grid, {
    ...
    initialize: function (name, url, params, options) {
        ...
        if (!this.noMagic && this.params.TRANSPARENT &&
            ...
            if ((options === null || options === undefined) || (!options.isBaseLayer)) {
