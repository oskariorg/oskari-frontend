...
function(instance) {
    ...
    startPlugin : function() {
        ...
        this.templateLayerFooterTools = jQuery('<div class="left-tools">' + '<div class="layer-visibility">' + '<a href="JavaScript:void(0);">' + loc['hide'] + '</a>' + '&nbsp;' + '<span class="temphidden" style="display: none;">' + loc['hidden'] + '</span>' + '</div>' + '<div class="layer-opacity">' + '<div class="layout-slider" id="layout-slider">' + '</div> ' + '<div class="opacity-slider" ' + 'style="display:inline-block">' + '<input type="text" name="opacity-slider" ' + 'class="opacity-slider opacity" ' + 'id="opacity-slider" />%</div>' + '</div>' + '</div>' + '<div class="right-tools">' + 
        //'<div class="layer-description">' + '<div class="wrapper">' + '</div>' + '</div>' + 
        '<div class="layer-rights"></div>' + 
        '<div class="layer-description"><a href="JavaScript:void(0);">' + '<div class="icon-info"></div></a></div></div>');
    ...
    _createLayerContainer : function(layer) {
        ...
        // FIXME: WMTS is an addition done by an outside bundle so this shouldn't
        // be here
