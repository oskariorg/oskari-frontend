/*
 * @class Oskari.mapframework.bundle.featuredata.Tile
 *
 * Renders the "featuredata" tile.
 */
Oskari.clazz.define('Oskari.mapframework.bundle.featuredata.Tile',

/**
 * @method create called automatically on construction
 * @static
 * @param {Oskari.mapframework.bundle.featuredata.LayerSelectionBundleInstance} instance
...
function(instance) {
     ...
     */
    getName : function() {
        return 'Oskari.mapframework.bundle.featuredata.Tile';
    },
    /**
     * @method setEl
     * @param {Object} el
    ...
    refresh : function() {
        ...
        if(this.shownLayerCount && layerCount != this.shownLayerCount) {
