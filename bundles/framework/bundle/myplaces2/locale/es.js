  ...
  "value": {
    ...
    "tools": {
      ...
      "line": {
        ...
        "new": "Añadir un hito sobre la línea haciendo click en el mapa. Parar la edición mediante doble click o pulsando \"Fin de edición\"",
      ...
      "area": {
        "tooltip": "Añadir área",
        "new": "Añadir hitos al área de tu polígono haciendo click en el mapa. Parar la edición mediante doble click o pulsando \"Fin de edición\". Para crear agujeros en los polígonos, mantén pulsada la tecla Alt.",
    ...
    "buttons": {
      ...
      "changeToPrivate": "Despublicar"
    },
    "placeform": {
      "title": "Datos del sitio",
      "tooltip": "Se guardará el sitio indicado en el mapa, en Mis sitios . Asigne un nombre al sitio y descríbalo. Puede seleccionar la capa donde se almacenará el sitio o elegir una nueva capa seleccionando \"Nueva capa\" en el menú desplegable de la capa.",
      "placename": {
        "placeholder": "Asigne un nombre al sitio"
      },
      "placelink": {
        "placeholder": "Asigne una URL"
      },
      "placedesc": {
    ...
    "notification": {
      ...
      "categorySaved": {
        "title": "Capa guardada",
        "message": "Guardados los cambios en la capa"
      },
      "categoryDelete": {
        "title": "Borrar capa",
