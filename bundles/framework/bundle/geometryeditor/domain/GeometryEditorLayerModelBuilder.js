/*
 * @class Oskari.mapframework.bundle.mapmyplaces.domain.GeometryEditorLayerModelBuilder
 * JSON-parsing for geometryeditor layer
 */
Oskari.clazz.define('Oskari.mapframework.bundle.geometryeditor.domain.GeometryEditorLayerModelBuilder',
    function (sandbox) {
        this.localization = Oskari.getLocalization("GeometryEditor");
