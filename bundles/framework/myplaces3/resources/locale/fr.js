    ...
    "value": {
        ...
        "tab": {
            ...
            "confirm": {
                ...
                "deleteCategoryWithMove": "La couche cartographique « {name} » contient {count} lieu(x). Souhaitez-vous supprimer la couche cartographique et déplacer ses lieux vers la couche cartographique par défaut « {moveTo} » ou souhaitez-vous supprimer la couche cartographique et ses lieux.",
