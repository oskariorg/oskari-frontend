    ...
    "value": {
        ...
        "tab": {
            ...
            "confirm": {
                ...
                "deleteConfirmMove": "Вы удаляете слой карты \"{0}\". Существует {1, несколоько, одно {# место} другие {# места}} на слое карты. Вы хотите: <br/> 1. удалить слой карты и его {1, несколько, одно {место} другие {места}} <br/> 2. переместить {1, несколько, одно {место} другие {места}} в слой карты по умолчанию перед удалением эього слоя карты?", // PersonalData removal
