    ...
    "value": {
        ...
        "tab": {
            ...
            "confirm": {
                ...
                "deleteCategoryWithMove": "Вы удаляете слой карты \"{name}\". Существует {count, несколоько, одно {# место} другие {# места}} на слое карты. Вы хотите: <br/> 1. удалить слой карты и его {count, несколько, одно {место} другие {места}} <br/> 2. переместить {count, несколько, одно {место} другие {места}} в слой карты по умолчанию перед удалением эього слоя карты?",
