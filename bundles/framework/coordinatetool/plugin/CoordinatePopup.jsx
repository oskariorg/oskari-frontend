...
const ProjectionChanger = ({ preciseTransform, projection, onChange, supportedProjections = [], children }) => {
        ...
        <Spin spinning={state.loading}>
            <Content>
                ...
                <ProjectionChanger
                    ...
                    supportedProjections={supportedProjections}>{crsText}</ProjectionChanger>
                <CoordinateFields>
                    <CoordinateField>
