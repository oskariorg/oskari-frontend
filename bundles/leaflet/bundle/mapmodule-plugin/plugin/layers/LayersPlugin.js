 ...
 */
Oskari.clazz.define('Oskari.leaflet.mapmodule.plugin.LayersPlugin',
/**
...
function() {
    ...
    init : function(sandbox) {
        this.requestHandlers = {
            layerVisibilityHandler : Oskari.clazz.create('Oskari.leaflet.bundle.mapmodule.request.MapLayerVisibilityRequestHandler', sandbox, this),
