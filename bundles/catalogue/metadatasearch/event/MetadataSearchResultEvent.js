/**
 * @class Oskari.mapframework.bundle.metadatasearch.event.MetadataSearchResultEvent
 *
 * Used to notify components metadata search response.
 */
Oskari.clazz.define('Oskari.mapframework.bundle.metadatasearch.event.MetadataSearchResultEvent',
/**
