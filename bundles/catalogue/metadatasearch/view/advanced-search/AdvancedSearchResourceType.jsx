...
export const AdvancedSearchResourceType = (props) => {
    ...
    return <AdvancedSearchRowContainer>
        ...
        { hasOptions && options.values.map(value => <Checkbox key={value.val}>{Oskari.getMsg(METADATA_BUNDLE_LOCALIZATION_ID, 'advancedSearch.resourceTypes.' + value.val)}</Checkbox>) }
