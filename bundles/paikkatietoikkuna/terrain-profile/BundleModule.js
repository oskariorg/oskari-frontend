/**
 * @class Oskari.mapframework.ui.module.common.terrain-profile.BundleModule
 * Abstract class, for inheritance only
 */
Oskari.clazz.define('Oskari.mapframework.bundle.terrain-profile.BundleModule', function () {
    this.sandbox = null;
}, {
    /**
