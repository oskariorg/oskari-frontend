Oskari.registerLocalization(
{
    ...
    "key": "elf-license",
    "value": {
        "getLicenseText": "Litsents",
        "errors": {
            "cannotGetLicenseInformation": {
                "title": "Viga",
                "message": "Litsentsi infot ei leitud"
            },
            "cannotGetLicensePrice": {
                "title": "Viga",
                "message": "Litsentsi hinda ei leitud"
            },
            "failedConclude": {
                "title": "Viga",
                "message": "Litsentsi ei sõlmitud"
            },
            "concludeNoResponse": {
                "title": "Viga",
                "message": "Litsentsi ei sõlmitud"
        ...
        "success": {
            "deactivateLicense": {
                "title": "Litsents deaktiveeritud",
                "message": "Deaktiveerimine õnnestus"
            }
        },
        "dialog": {
            ...
            "deactivateConfirm": {
                "title": "Litsentsi deaktiveerimine",
                "message": "Kas tahad litsentsi deaktiveerida?"
            },
            "validTo": "Litsents kehtib kuni {day}.",
            "licenseId": "Litsentsi ID: {licenseid}",
