...
Oskari.clazz.define('Oskari.mapframework.bundle.toolbar.request.ToolbarRequestHandler',
    ...
    function (toolbar) {
        ...
        _handleRemove: function (sandbox, request) {
            this._toolbar.removeToolButton(request.getId(), request.getGroup());
        },
        _handleState: function (sandbox, request) {
            this._toolbar.changeToolButtonState(request.getId(), request.getGroup(), request.getState());
        },
        _handleClick: function (sandbox, request) {
            this._toolbar._clickButton(request.getId(), request.getGroup());
        }
    }, {
        /**
