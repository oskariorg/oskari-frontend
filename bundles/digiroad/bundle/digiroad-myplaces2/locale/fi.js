Oskari.registerLocalization({
  ...
  "value": {
    ...
    "desc": "",
    "category": {
      "defaultName": "Uudet kohteet",
      "organization": "Tuotetut kohteet",
      "inspire": "Tuotetut kohteet"
    },
    "guest": {
    ...
    "tools": {
      "point": {
        "tooltip": "Lisää palautepiste",
        "new": "Lisää palautepiste klikkaamalla karttaa.",
        "edit": "Siirrä pistettä raahaamalla.",
        "save": "Tallenna sijainti"
      },
      "line": {
        "tooltip": "Lisää uusi tiesegmentti",
    ...
    "placeform": {
      ...
      "tooltip": "Kun lisäät kohteen kartalle, se tallentuu Omiin tietoihisi. Anna kohteelle tietolaji ja arvo.",
      "placename": {
    ...
    "feedbackform": {
        "title": "Palautekuvio",
        "tooltip": "Voit piirtää vapaamuotoisen alueen tai pisteen palautetta varten. Anna piirretylle kohteelle nimi ja kuvaus.",
        "feedbackname": {
          "placeholder": "Anna kohteen nimi"
        },
        "feedbackdesc": {
          "placeholder": "Palautekuvaus"
        },
        "category": {
          "label": "Karttataso",
          "new": "Uusi taso..."
    ...
    "validation": {
      ...
      "dynType": "Tietolaji puuttuu.",
      "dynValue": "Tiedon arvo puuttuu.",
