module.exports = function (grunt) {
	grunt.registerTask('buildOpenLayers','', function(mode) {
		var ol3Builder = require('../node_modules/openlayers/tasks/build.js'),
			ol3BuildConfig = (mode !== "debug") ? require('../node_modules/openlayers/config/ol.json') : require('../node_modules/openlayers/config/ol-debug.json'),
    ...
    grunt.registerTask(
        ...
        function () {
			var sourcePath = '../libraries/ol3/oskari/*.js',
				destPath = 'node_modules/openlayers/src/ol/';
