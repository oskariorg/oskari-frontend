/**
 * @class Oskari.poc.yuilibrary.Main
 *
...
(function() {
	...
	Oskari.clazz.define('Oskari.poc.yuilibrary.Main', function() {
		...
		appSetup : {
			 ...
			 */
			{
				...
				metadata : {
					...
					"Require-Bundle-Instance" : ["featureinfo", "layerselector", "mappublisher"]
				},
				instanceProps : {}
			}]
		}
	 ...
	 * Demo only
	 */
	Oskari.clazz.category('Oskari.poc.yuilibrary.Main', 'demo', {
	...
	$(document).ready(function() {
		...
		var main = Oskari.clazz.create('Oskari.poc.yuilibrary.Main');
