...
(function() {
	...
	Oskari.clazz.define('Oskari.poc.extjs.Main', function() {
		...
		appSetup : {
			...
			{
				callback : function() {
					if( isDev ) Oskari.setLoaderMode('dev');
				},
	 ...
	 * Demo only
	 */
	Oskari.clazz.category('Oskari.poc.extjs.Main', 'demo', {
	...
	$(document).ready(function() {
		...
		var main = Oskari.clazz.create('Oskari.poc.extjs.Main');
