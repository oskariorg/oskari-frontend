...
(function() {
	...
	Oskari.clazz.define('Oskari.poc.jqueryui.Main', function() {
	 ...
	 * Demo only
	 */
	Oskari.clazz.category('Oskari.poc.jqueryui.Main', 'demo', {
	...
	$(document).ready(function() {
		...
		var main = Oskari.clazz.create('Oskari.poc.jqueryui.Main');
