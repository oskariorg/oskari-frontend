/**
 * @class Oskari.poc.jqueryui.Main
 *
 * Launcher Class for a sample featuring jqueryui.js and 960 layout
 *
 * /poc/jqueryui/index.html?oskariLoaderMode=yui&style=style1&zoomLevel=8&coord=528574_6759496&mapLayers=base_35+100+!default!,90+100+&showMarker=false&forceCache=true
 *
 */
(function() {
	...
	Oskari.clazz.define('Oskari.poc.extjsqsg.Main', function() {
		...
		appSetup : {
			 ...
			 */
			{
				...
				metadata : {
					...
					"Require-Bundle-Instance" : ['flyoutadapter', 'layerhandler', 'mapoverlaypopup']
				},
				instanceProps : {}
			}, {
				title : 'Layer Selection Bundle',
				fi : 'Layer Selection Bundle',
				sv : '?',
				en : 'Layer Selection Bundle',
				...
				title : 'Position Info Bundle',
				fi : '?',
				sv : '?',
				en : 'Position Info Bundle',
				bundlename : 'positioninfo',
				bundleinstancename : 'positioninfo',
				metadata : {
					"Import-Bundle" : {
						"positioninfo" : {
							bundlePath : '../../samples/quickstartguide/bundle/'
						}
					},
					"Require-Bundle-Instance" : []
				},
	 ...
	 * Demo only
	 */
	Oskari.clazz.category('Oskari.poc.extjsqsg.Main', 'demo', {
	...
	$(document).ready(function() {
		...
		var main = Oskari.clazz.create('Oskari.poc.extjsqsg.Main');
