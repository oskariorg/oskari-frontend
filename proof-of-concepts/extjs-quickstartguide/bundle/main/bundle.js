Oskari.clazz.define("Oskari.poc.extjsqsg.bundle.MainBundle", function() {

}, {
	"create" : function() {

		return Oskari.clazz.create("Oskari.poc.extjsqsg.bundle.MainBundleInstance");
	},
...
Oskari.bundle_manager.installBundleClass("main", "Oskari.poc.extjsqsg.bundle.MainBundle");
