...
Oskari.clazz.define("Oskari.poc.dojo.LayerSelectionBundle", function() {
	...
	"source" : {
		...
		"scripts" : [{
			...
			"src" : "../../../../proof-of-concepts/dojo/bundle/layerselection/instance.js"

		}, {
			"type" : "text/javascript",
			"src" : "../../../../proof-of-concepts/dojo/bundle/layerselection/Flyout.js"

		}, {
			"type" : "text/javascript",
			"src" : "../../../../proof-of-concepts/dojo/bundle/layerselection/Tile.js"
	...
	"bundle" : {
		"manifest" : {
			"Bundle-Identifier" : "dojo-layerselection",
			"Bundle-Name" : "dojo-layerselection",
			"Bundle-Author" : [{
				"Name" : "jjk",
				"Organisation" : "nls.fi",
				"Temporal" : {
	 ...
	 */
	"dojo" : ["dojo", "dojo/dom", "dijit/form/Slider", "dijit/form/HorizontalSlider", "dojo/dom-construct", "dojo/parser", "dojo/query"]
});

Oskari.bundle_manager.installBundleClass("dojo-layerselection", "Oskari.poc.dojo.LayerSelectionBundle");
