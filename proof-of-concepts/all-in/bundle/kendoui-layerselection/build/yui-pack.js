...
Oskari.clazz
		.define(
				"Oskari.poc.kendoui.bundle.LayerSelectionBundleInstance",
				function() {
					this.map = null;
					this.core = null;
					this.sandbox = null;
				...
				},
				{
					...
					startExtension : function() {
						this.plugins['Oskari.userinterface.Flyout'] = Oskari.clazz
								.create(
										'Oskari.poc.kendoui.layerselection.Flyout',
										this);
						this.plugins['Oskari.userinterface.Tile'] = Oskari.clazz
						.create(
								'Oskari.poc.kendoui.layerselection.Tile',
								this);
					},
						...
						$(layers).each(function(index) {
							...
							sliderEl.kendoSlider({
								...
								slide: function(evnt) { 
									...
									sandbox.request(instance.getName(), 
