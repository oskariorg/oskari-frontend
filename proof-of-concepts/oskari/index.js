...
(function() {
	...
	/* Set this to true when developing modifiying */

		var isDev = false;

	/* Let's create Main for this papplication */

	Oskari.clazz.define('Oskari.poc.oskari.Main', function() {
		...
		appSetup : {
			...
			"startupSequence" : [
			/*
			 * style selection may be done with CSS Links
			 * also - just for demo
			 */
	 ...
	 * Demo only
	 */
	Oskari.clazz.category('Oskari.poc.oskari.Main', 'demo', {
	...
	$(document).ready(function() {
		...
		var main = Oskari.clazz.create('Oskari.poc.oskari.Main');
