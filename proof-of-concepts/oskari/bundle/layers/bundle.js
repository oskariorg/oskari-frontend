 ...
 *
 */
Oskari.clazz.define("Oskari.mapframework.oskari.layers.Bundle",
/**
 * @constructor
 *
 ...
 */
{
	...
	"bundle" : {
		"manifest" : {
			...
			"Bundle-Name" : "mapframework.oskari.layers.Bundle",
			"Bundle-Author" : [{
				"Name" : "jjk",
				"Organisation" : "nls.fi",
				"Temporal" : {
 ...
 *
 */
Oskari.bundle_manager.installBundleClass("layers", "Oskari.mapframework.oskari.layers.Bundle");
