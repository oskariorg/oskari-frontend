...
(function() {
	...
	Oskari.clazz.define('Oskari.poc.dojo.Main', function() {
		...
		appSetup : {
			 ...
			 */
			{
				...
				metadata : {
					...
					"Require-Bundle-Instance" : ['featureinfo', 'mappublisher']
				},
				instanceProps : {}
			}]
		}
	 ...
	 * Demo only
	 */
	Oskari.clazz.category('Oskari.poc.dojo.Main', 'demo', {
	...
	require(["dojo/domReady!"], function() {
		...
		var main = Oskari.clazz.create('Oskari.poc.dojo.Main');
