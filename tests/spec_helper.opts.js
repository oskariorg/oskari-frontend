...
function simulateMouseDrag(map, x0, y0, x1, y1) {
    map.events.triggerEvent("mousemove", {type: "mousemove", xy: new OpenLayers.Pixel(x0, y0), which: 1});
    map.events.triggerEvent("mousedown", {type: "mousedown", xy: new OpenLayers.Pixel(x0, y0), which: 1});
    map.events.triggerEvent("mousemove", {type: "mousemove", xy: new OpenLayers.Pixel(x1, y1), which: 1});
    map.events.triggerEvent("mouseup", {type: "mouseup", xy: new OpenLayers.Pixel(x1, y1), which: 1});
}
