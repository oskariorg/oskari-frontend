...
Oskari.clazz.define('Oskari.karttatiili.Main', function() {
		 ...
		 */
		{
			...
			metadata : {
				"Import-Bundle" : {
					...
					"layers" : {
						bundlePath : '../../applications/karttatiili.fi/bundle/'
					},
					"main" : {
						bundlePath : '../../applications/karttatiili.fi/bundle/'
					},
			...
			metadata : {
				"Import-Bundle" : {
					"myfeatures" : {
						bundlePath : '../../samples/sade3/bundle/'
					},
					"myplaces" : {
						bundlePath : '../../packages/framework/bundle/'
					}
...
$(document).ready(function() {
	...
	var main = Oskari.clazz.create('Oskari.karttatiili.Main');
